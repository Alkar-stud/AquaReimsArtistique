                ...
                <?php foreach ($groupes as $groupe): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <span>
                            ...
                            <small class="text-muted"><?= htmlspecialchars($groupe->getCoach()) ?></small>
                        </span>
                ...
                <?php foreach ($groupes as $groupe): ?>
                    <tr>
                        <form action="/gestion/groupes-nageuses/update/<?= $groupe->getId() ?>" method="POST">
                            <td><input type="text" name="libelle" class="form-control" required value="<?= htmlspecialchars($groupe->getLibelle()) ?>"></td>
                            <td><input type="text" name="coach" class="form-control" value="<?= $groupe->getCoach() ? htmlspecialchars($groupe->getCoach()):'' ?>"></td>
                            ...
                            <td class="text-center"><input type="checkbox" name="is_active" <?= $groupe->getIsActive() ? 'checked' : '' ?>></td>
                            <td>
