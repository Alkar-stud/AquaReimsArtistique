...
-- Ajout des mails_templates
INSERT IGNORE INTO `mails_templates` (`code`, `subject`, `body_html`, `body_text`) VALUES
    ...
    ('new_account', 'Votre compte {app_name}', '<p>Bonjour {username},</p>\r\n<p>Votre compte {app_name} a été créé. Veuillez cliquer sur le lien ci-dessous pour saisir le mot de passe associé :</p>\r\n<p><a href="{link}">Créer mon mot de passe</a></p>\r\n<p>Ce lien expirera dans {timeout_token_new_account}.</p>', 'Bonjour {username},\r\nVotre compte {app_name} a été créé. Veuillez cliquer sur le lien ci-dessous pour saisir le mot de passe associé :\r\n\r\n<a href="{link}">Créer mon mot de passe</a>\r\nCe lien expirera dans {timeout_token_new_account}.');