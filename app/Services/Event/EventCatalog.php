...
final class EventCatalog
{
    ...
    public static function all(): array
    {
        ...
        $map = [
            ...
            'mail.reservation.paiement_relance.sent' => new EventDefinition('mail.reservation.paiement_relance.sent', 'mail', 'INFO', false, false, 'Mail de relance de paiement envoyé.', true, null),
            'mail.reservation.paiement_relance.failed' => new EventDefinition('mail.reservation.paiement_relance.failed', 'mail', 'ERROR', false, true, 'Échec d envoi du mail de relance de paiement.', false, 1800),
