<div class="container-fluid">
    ...
    <div class="container-fluid" id="reservation-data-container" data-base-due-cents="{{ (int)($grandTotal) }}">
        ...
        <div class="mb-3 text-end">
            ...
            <div class="d-inline-block align-middle">
                ...
                <input type="number" id="donation-amount-input" min="0" step="0.1" value="0" class="form-control form-control-sm" style="width: 90px; display: inline-block;" name="donation"  form="confirmForm"> €
    ...
    <ul class="list-group mb-4">
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <strong id="total-amount">{{ number_format($grandTotal / 100, 2, ',', ' ') }} €</strong>
        </li>
    </ul>
