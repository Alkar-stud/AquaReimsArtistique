 ...
 */
    public function validatePayerInformation(string $nom, string $prenom, string $email, string $telephone): array
    {
  ...
  /**
     ...
     */
    public function processAndValidateStep3Submission(array $input, array $reservationData): array
    {
        $eventId = $reservationData['event_id'] ?? null;
        if (!$eventId) {
