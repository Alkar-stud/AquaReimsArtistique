...
('Temps pour le timeout de session', 'TIMEOUT_SESSION', 'PT60M', 'string'),
('Temps pour le timeout de réservation de place', 'TIMEOUT_PLACE_RESERV', 'PT2H', 'string'),
...
('% max de la commande pour la jauge de don', 'DONATION_SLIDER_MAX_PERCENTAGE', '100', 'int'),
('Host du site pour le cron', 'HOST_SITE', 'host.com', 'string');
